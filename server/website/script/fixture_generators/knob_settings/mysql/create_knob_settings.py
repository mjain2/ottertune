...
def main():
    final_metrics = []
    with open('MySQLCurrentSettings.txt', 'r') as f:
        num = 0
        ...
        for line in lines:
            ...
            num = (num + 1) % 3
    with open('mysql_knobs.json', 'w') as f:
        json.dump(final_metrics, f, indent=4)
    shutil.copy("mysql_knobs.json", "../../../../website/fixtures/mysql_knobs.json")
